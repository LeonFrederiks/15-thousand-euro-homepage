...
class PixelCanvas {
    ...
    resizeCanvas() {
        ...
        // Calculate scale to fit canvas while maintaining 1920x1080 ratio
        const scaleX = containerWidth / this.ORIGINAL_WIDTH;
        const scaleY = containerHeight / this.ORIGINAL_HEIGHT;
        const scale = Math.min(scaleX, scaleY); // Use min to ensure canvas fits and maintains ratio
        ...
        // Re-render in fullscreen mode to ensure proper scaling
