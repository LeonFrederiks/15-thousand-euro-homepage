...
class PurchaseFlow {
    ...
    setupEventListeners() {
        ...
        // Custom size
        this.customWidth.addEventListener('input', () => this.handleCustomWidthInput());
        this.customHeight.addEventListener('input', () => this.handleCustomHeightInput());
        this.customWidth.addEventListener('blur', () => this.snapWidthToMax());
        this.customHeight.addEventListener('blur', () => this.snapHeightToMax());
    ...
    handleCustomWidthInput() {
        const value = this.customWidth.value;
        
        // Hide placeholder when typing
        if (value) {
            this.customWidth.placeholder = '';
        } else {
            this.customWidth.placeholder = 'x size';
        }
        
        this.updateCustomSize();
    }
    
    handleCustomHeightInput() {
        const value = this.customHeight.value;
        
        // Hide placeholder when typing
        if (value) {
            this.customHeight.placeholder = '';
        } else {
            this.customHeight.placeholder = 'y size';
        }
    ...
    snapWidthToMax() {
        const value = parseInt(this.customWidth.value) || 0;
        if (value > 1920) {
            this.customWidth.value = 1920;
        }
        this.updateCustomSize();
    }
    
    snapHeightToMax() {
        const value = parseInt(this.customHeight.value) || 0;
        if (value > 1080) {
            this.customHeight.value = 1080;
        }
        this.updateCustomSize();
    }
