...
class PixelCanvas {
    constructor() {
        ...
        this.scale = 0.3; // Start zoomed out to see the whole canvas
        this.offsetX = 0;
        this.offsetY = 0;
        ...
        this.purchasedPixels = [
            { x: 100, y: 100, width: 30, height: 30, image: null, link: 'https://example1.com', text: 'First Purchase! - Click to visit' },
            { x: 200, y: 200, width: 30, height: 30, image: null, link: 'https://example2.com', text: 'Another Pixel! - Click to visit' },
            { x: 300, y: 150, width: 30, height: 30, image: null, link: 'https://example3.com', text: 'Pixel Art! - Click to visit' },
            { x: 500, y: 300, width: 50, height: 40, image: null, link: 'https://testsite.com', text: 'Test Site - See the link!' },
            { x: 800, y: 200, width: 35, height: 35, image: null, link: 'https://mybusiness.com', text: 'My Business Website' }
        ];
    ...
    onMouseDown(e) {
        ...
        // Otherwise, start dragging to pan the canvas
    ...
    updateZoomDisplay() {
        const zoomLevel = document.getElementById('currentZoom');
        if (zoomLevel) {
